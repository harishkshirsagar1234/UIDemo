...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
  ...
  //  ViewController2 *vc2 = [[ViewController2 alloc]init];
   ...
   // DaeViewController *dvc =[[DaeViewController alloc]init];
  //TableViewController *tvc= [[TableViewController alloc]init];
  //  CalViewController *cvc=[[CalViewController alloc]init];
  //  AddTableViewController *avc =[[AddTableViewController alloc]init];
    
    // MyTableViewController *m=[[MyTableViewController alloc]initWithStyle:UITableViewStylePlain];
  //  TimerViewController *tvc =[[TimerViewController alloc]init];
    //SearchbarViewController *svc=[[SearchbarViewController alloc]init];
